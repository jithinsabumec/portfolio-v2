...
export default function Footer() {
    return (
        <footer className="w-full flex flex-col items-center justify-center bg-[#efefef]">
            {/* Main Footer Content */}
            <div className="w-full max-w-[1440px] px-8 md:px-[60px] lg:px-[160px] py-[40px] flex flex-col md:flex-row justify-between items-start border-t border-[#d7d7d7]">

                {/* Left Side: Jithin Sabu */}
                <div className="font-semibold text-[54px] leading-[49px] text-black mb-10 md:mb-0">
                    <p>Jithin</p>
                    <p>Sabu</p>
                </div>

                {/* Right Side: Links */}
                <div className="flex flex-col gap-[60px] items-start w-full md:w-auto">

                    {/* Let's Talk Section */}
                    <div className="flex flex-col gap-[18px] items-start w-full">
                        <p className="font-medium text-[24px] text-black tracking-[-0.48px]">Let’s Talk</p>
                        <div className="flex gap-[12px] w-full flex-wrap">
                            {/* Email Button */}
                            <Link
                                href="mailto:jithinsabu.mec@gmail.com"
                                className="bg-white rounded-[12px] border border-[#d7d7d7] shadow-[0px_2px_5px_0px_rgba(0,0,0,0.05)] w-fit h-[48px] px-5 flex items-center justify-center gap-[12px] hover:bg-gray-50 transition-colors"
                            >
                                <div className="relative w-[25px] h-[19px]">
                                    <Image src="/assets/gmail-icon.png" alt="Email" fill className="object-contain" />
                                </div>
                                <span className="font-mono font-normal text-[20px] text-black uppercase tracking-[-0.5px]">EMAIL ME</span>
                            </Link>
                            ...
                            >
                                ...
                                <span className="font-mono font-normal text-[20px] text-black uppercase tracking-[-0.5px]">CALL ME</span>
                            </Link>
                        </div>
                    </div>
                    ...
                    {/* Follow Me Section */}
                    <div className="flex flex-col gap-[18px] items-start w-full">
                        <p className="font-medium text-[24px] text-black tracking-[-0.48px]">Follow me</p>

                        <div className="grid grid-cols-2 grid-rows-2 gap-[12px] w-fit">
                            {/* LinkedIn */}
                            <Link
                                href="https://linkedin.com/in/jithinsabu"
                                target="_blank"
                                className="bg-white rounded-[24px] border border-[#d7d7d7] h-[44px] px-[6px] w-[166px] flex items-center justify-center gap-[8px] hover:bg-gray-50 transition-colors"
                            >
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="bg-white rounded-[24px] border border-[rgba(215,215,215,1)] h-[44px] px-[2px] w-[166px] flex items-center justify-center gap-[8px] hover:bg-gray-50 transition-colors"
                            >
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="bg-white rounded-[24px] border border-[rgba(215,215,215,1)] h-[44px] px-[6px] w-[166px] flex items-center justify-center gap-[4px] hover:bg-gray-50 transition-colors"
                            >
                                <div className="w-[24px] h-[24px] flex items-center justify-center relative">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="bg-white rounded-[24px] border border-[#d7d7d7] h-[44px] px-[6px] w-[166px] flex items-center justify-center gap-[12px] hover:bg-gray-50 transition-colors"
                            >
            ...
            {/* Bottom Bar */}
            <div className="bg-black w-full h-[48px] flex items-center justify-center">
                <div className="flex items-center gap-1.5 text-white text-[17px] font-normal font-sans">
